...
public class ShareReflectUtil {
    ...
    public static Field findField(Object instance, String name) throws NoSuchFieldException {
        ...
        throw new NoSuchFieldException("Field ".concat(name).concat(" not found in ").concat(instance.getClass().toString()));
    }
    ...
    public static Field findField(Class<?> originClazz, String name) throws NoSuchFieldException {
        ...
        throw new NoSuchFieldException("Field ".concat(name).concat(" not found in ").concat(originClazz.toString()));
    }
    ...
    public static Method findMethod(Object instance, String name, Class<?>... parameterTypes)
        ...
        throw new NoSuchMethodException("Method "
                ...
                .concat(Arrays.asList(parameterTypes).toString())
                .concat(" not found in ")
                .concat(instance.getClass().toString()));
    }
    ...
    public static Constructor<?> findConstructor(Object instance, Class<?>... parameterTypes)
        ...
        throw new NoSuchMethodException("Constructor"
                .concat(" with parameters ")
                .concat(Arrays.asList(parameterTypes).toString())
                .concat(" not found in ").concat(instance.getClass().toString()));
    }
